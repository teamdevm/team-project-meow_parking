...
2) После установки node.js, нужно перейти в папку с проектом (/client) и в консоли прописать npm install react
...
0) Восстановить БД с названием parking_information из db/init.sql файла
