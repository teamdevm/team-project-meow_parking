...
1) В ветке newdocker скачать все файлы
2) В терминале зайти в корневую папку скачанного в предыдущем шаге проекта
3) Выполнить команду "[sudo] docker compose build", затем "[sudo] docker compose up"
4) Зайти на localhost:3000 в браузере
